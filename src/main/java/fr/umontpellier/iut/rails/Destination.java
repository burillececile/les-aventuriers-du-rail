...
public class Destination {
    ...
    private String ville1;  //Ville de départ
    private String ville2;  //Ville d'arrivée
    private int valeur; //Nombre de points que vaut la destination
    ...
    public static ArrayList<Destination> makeDestinationsEurope() { //@return une liste contenant toutes les destinations "normales" du jeu
    ...
    public static ArrayList<Destination> makeDestinationsLonguesEurope() {  //@return une liste contenant toutes les destinations "longues" du jeu
        ArrayList<Destination> destinations = new ArrayList<>();
